...
#sentences = word2vec.LineSentence('Sciences.txt') #正式训练前的格式化

#训练语料

#path = get_tmpfile("word2vec088.model") #创建临时文件
#model = word2vec.Word2Vec(sentences,sg=1, hs=0,min_count=1,window=10,vector_size=100)
#model.wv.save_word2vec_format("word2vec0888.bin")
#model = KeyedVectors.load_word2vec_format('word2Vecsciences.bin', binary= True)
#model = gensim.models.KeyedVectors.load_word2vec_format('word2Vecsciences.bin',unicode_errors='ignore')
#model = gensim.models.Word2Vec.load('word2vec0888.model')
'''
...
#taiy = ['太阳能电池','光电','受体','光伏电池','吸光','DSCs','器件','能源','卤化物','转换','半导体','n','光伏','发光','染料','敏化','光热','杂化','光催化','电致','空穴','钙钛矿太阳能电池','太阳能电池材料']
#dian = ['电池','锂离子','负极','正极','电流','硅','锂电池','LiCoO2','电压','LIBs','锂','脱嵌','电容','LiNi','离子','CoxMnyO2','储能','热电','锰','电压','硅碳','Sn','石墨']
